...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"inviteFriendType" forIndexPath:indexPath];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    AddFriendsFromTableViewController * contacts_table = [segue destinationViewController];
    NSIndexPath *path = [self.tableView indexPathForSelectedRow];
    if (path.row == 0){
        contacts_table.viewTitle = @"From Contacts";
    }
    else if (path.row == 1){
